...
const Register = () => {
    ...
    const navigate = useNavigate();
      ...
      const saveUser = (name, email) =>{
       ...
       fetch('https://healthcare-server-zeta.vercel.app/users', {
           method: 'POST',
           headers: {
    ...
    return (
        ...
        <form onSubmit={handleSubmit(handleSignUp)}  novalidate="" action="" className="space-y-12 ng-untouched ng-pristine ng-valid">
            ...
            <div className="space-y-2">
                <div>
                    <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-sky-300 text-gray-900">Register</button>
                </div>
